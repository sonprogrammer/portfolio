export const mungpassTechChoice = {
  title: '기술 선택 배경',
  description: "실제 서비스로의 확장 가능성을 고려해 데이터 구조, 상태 관리, 권한 처리와 유지보수성을 함께 고려하여 기술을 구성했습니다.",
  ...
  points: [
    ...
    "TanStack Query는 매장, 상품, 이용 내역처럼 서버에서 관리되는 데이터의 요청과 캐시를 담당하고 Zustand는 역할 선택이나 UI와 관련된 클라이언트 상태를 관리하도록 책임을 분리했습니다. 서버 데이터 조회·변경 로직은 TanStack Query 기반 Custom Hook으로 구성해 컴포넌트가 UI 표현에 집중할 수 있도록 했습니다.",
